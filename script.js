function changeSection(element) {
    ...
    var imageInfo = [
      {
        basePath: 'wimages/Watch 1.png',
        set: ['wimages/Watch 1 4.png', 'wimages/Watch 1 2.png', 'wimages/Watch 1 3.png']
      },
      {
        basePath: 'wimages/Watch 2.png',
        set: ['wimages/Watch 1 1.png', 'wimages/Watch 1 2.png', 'wimages/Watch 1 3.png']
      },
      {
        basePath: 'wimages/Watch 3.png',
        set: ['wimages/Watch 1 1.png', 'wimages/Watch 1 4.png', 'wimages/Watch 1 3.png']
      },
      {
        basePath: 'wimages/Watch 4.png',
        set: ['wimages/Watch 1 1.png', 'wimages/Watch 1 4.png', 'wimages/Watch 1 2.png']
      }
    ];
